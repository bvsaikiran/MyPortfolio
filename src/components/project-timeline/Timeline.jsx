        ...
        <div id="projects">
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
                ...
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> We had build a Whatsapp Clone.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>You can sign in with google account.</li>
                          <li>You can chat with friends</li>
                          <li>You can see you Display picture</li>
                          <li>You can create a new group</li>
                          <li>
              ...
              <UrlButton
                  href="https://whats-app-clone-6dfe7.web.app/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
